...
VALUES
  ...
  (9780262033848, "Introduction to Algorithms, 3rd Edition", "MIT Press", "Algorithms_3rd.pdf"),
  (9780133741629, "Ethics for the Information Age, 6th Edition", "Michael Quinn", "ethics_for_the_information_age.pdf"),
  (9780133407150, "Fundamentals of Web Development", "Randy Connolly", "Fundamentals_Web_Devlopment.pdf"),
  (9781524916992, "Introduction to Programming Languages", "Yinong Chen", "Intro_Programming_Languages.pdf"),
  (9780511264016, "Logic in Computer Science", "Michael Ruth", "LogicInCS.pdf"),
